...
> By default intro transitions will not play on first render. You can modify this behavior by setting `intro: true` when you [create a component](/docs/client-side-component-api) and marking the transition as `global`.
